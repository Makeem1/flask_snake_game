...
# 		response = login('admin@local.host', 'password')
#         assert response.status_code == 200
...
#         response = self.login(identity='diable@local.com')

#         assert_status_with_message(200, response,
#                                    'Your account has been disable, please contact the customer for further information')
