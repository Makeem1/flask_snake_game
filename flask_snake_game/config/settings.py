...
MAIL_USE_TLS = True
MAIL_USE_SSL = False
MAIL_USERNAME = 'patrickpwilliahfhhewfgmail.com'  # This email is not correct and will be overwritten by instance file
MAIL_PASSWORD = 'kcfdfvyvfeguw'  # This password is not and will be overwritten by instance settings file
